(function (_) {
    ...
    class Progress {
        constructor(parent = null) {
            ...
            this.elem_root = document.createElement('div');
            this.elem_ch1F = document.createElement('div');
            // this.elem_ch1E = document.createElement('div');
            this.elem_bkdp = document.createElement('div');

            this.elem_root.classList.add(StringTable[0xC002]);
            this.elem_ch1F.classList.add(StringTable[0xC003]);
            this.elem_ch1F.classList.add(StringTable[0xC005]);
            // this.elem_ch1E.classList.add(StringTable[0xC003]);
            // this.elem_ch1E.classList.add(StringTable[0xC004]);
            this.elem_bkdp.classList.add(StringTable[0xC006]);

            this.elem_root.append(this.elem_ch1F);
            // this.elem_root.append(this.elem_ch1E);
            this.elem_root.append(this.elem_bkdp);

            (parent || document.body || document.documentElement).append(this.elem_root);
            ...
            defprop(this, 'value', {
                ...
                set(newValue) {
                    if (
                        ...
                        newValue < this.__min__ || newValue > this.__max__
                    ) throw new TypeError(StringTable[0xE003]);
            ...
            defprop(this, 'min', {
                get() { return (this.__min__) },
                set(newValue) {
                    if (
                        typeof newValue !== 'number' ||
                        newValue > this.__max__
                    ) throw new TypeError(StringTable[0xE003]);
                    this.__min__ = newValue;
                    this.redraw();
                },
                enumerable: true
            });
            defprop(this, 'max', {
                get() { return (this.__max__) },
                set(newValue) {
                    if (
                        typeof newValue !== 'number' ||
                        newValue < this.__min__
                    ) throw new TypeError(StringTable[0xE003]);
                    this.__max__ = newValue;
                    this.redraw();
                },
                enumerable: true
            });
